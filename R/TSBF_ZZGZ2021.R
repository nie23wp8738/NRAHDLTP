...
#'
#'
#' @references Zhang, J. T., Zhou, B., Guo, J., & Zhu, T. (2021). Two-sample Behrens–Fisher problems for high-dimensional data: A normal reference approach. Journal of Statistical Planning and Inference, 213, 142-161.
